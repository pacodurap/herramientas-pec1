...
console.log('Paco Durán Aparici'); // Lazy Youtube.js
...
if (window.addEventListener) // W3C DOM
  window.addEventListener('load', setVideoFrames, false);else if (window.attachEvent) {
  // IE DOM
...
//# sourceMappingURL=/pec1.e31bb0bc.js.map